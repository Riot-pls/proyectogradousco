...
export class SolicitudService {
  ...
  crearSolicitud(solicitud: Solicitud) {
    const url = this.siteUrl + '/solicitud';
  ...
  actualizarSolicitud(solicitud: Solicitud) {
    const url = this.siteUrl + '/solicitud/' + solicitud._id + '?token=' + this.token;
  ...
  cargarSolicitudes(desde: number= 0) {
    const url = this.siteUrl + '/solicitud?desde=' + desde;
  ...
  */
  ...
  borrarSolicitudes(id: string) {
    const url = this.siteUrl + '/solicitud/' + id + '?token=' + this.token;
