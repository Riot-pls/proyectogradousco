...
export class ProyectoService {
  ...
  crearProyecto(proyecto: Proyecto) {
    const url = this.siteUrl + '/proyecto';
  ...
  actualizarProyecto(proyecto: Proyecto) {
    const url = this.siteUrl + '/proyecto/' + proyecto._id + '?token=' + this.token;
  ...
  cargarProyectos(desde: number= 0) {
    const url = this.siteUrl + '/proyecto?desde=' + desde;
  ...
  */
  ...
  borrarProyectos(id: string) {
    const url = this.siteUrl + '/proyecto/' + id + '?token=' + this.token;
