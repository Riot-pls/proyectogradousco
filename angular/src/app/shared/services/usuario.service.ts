...
export class UsuarioService {
  ...
  renuevaToken() {
    ...
    let url = this.siteUrl + '/login/renuevatoken?token=' + this.token;
  ...
  actualizarUsuario(usuario: Usuario) {
    ...
    let url = this.siteUrl + '/usuario/' + usuario._id + '?token=' + this.token;
  ...
  obtenerJefePrograma(numDocumento: string) {
    ...
    let url = this.siteUrl + '/usuario/' + numDocumento;
  ...
  cargarUsuarios(desde: number = 0) {
    ...
    let url = this.siteUrl + '/usuario?desde=' + desde;
    return this.http.get(url).map((resp: any) => {
  ...
  buscarUsuarios(termino: string) {
    let url = this.siteUrl + '/busqueda/coleccion/usuarios/' + termino;
  ...
  borrarUsuario(id: string) {
    let url = this.siteUrl + '/usuario/' + id + '?token=' + this.token;
