...
export class SedeService {
  ...
  crearSede(sede:Sede){
    ...
    let url = this.siteUrl+'/sedeUniversitaria';
  ...
  actualizarSede(sede:Sede){
    ...
    let url = this.siteUrl+'/sedeUniversitaria/'+sede._id+'?token='+this.token;
  ...
  cargarSedes(desde:number=0){
    ...
    let url=this.siteUrl+'/sedeUniversitaria?desde='+desde;
  ...
  buscarSedes(termino:string){
    ...
    let url=this.siteUrl+'/busqueda/coleccion/sedeUniversitaria/'+termino;
  ...
  borrarSedes(id:string){
    ...
    let url=this.siteUrl+'/sedeUniversitaria/'+id+'?token='+this.token;
